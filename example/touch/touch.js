...
(function () {
    ...
    AlloyTouch.prototype = {
        ...
        _start: function (evt) {
            ...
            this.custom_pv=this.target[this.property]
            this.touchStart.call(this, evt, this.target[this.property],this.custom_pv);
            cancelAnimationFrame(this.tickID);
            this._calculateIndex();
        ...
        _move: function (evt) {
            if (this.isTouchStart) {
                ...
                if(!this._preventMove) {
                    ...
                    this.change.call(this, this.target[this.property],this.custom_pv);
                    var timestamp = new Date().getTime();
                    if (timestamp - this.startTime > 300) {
                        this.startTime = timestamp;
                        this.start = this.vertical ? this.preY : this.preX;
                    }
                    this.touchMove.call(this, evt, this.target[this.property],d,this.custom_pv);
                }
        ...
        _end: function (evt) {
            if (this.isTouchStart) {
                ...
                var self = this,
                    ...
                    current_custom_pv=this.custom_pv,
                ...
                if (this.touchEnd.call(this, evt, current,current_custom_pv, this.currentPage) === false) return;
                if ((this.hasMax && current > this.max)||(this.hasMax && current_custom_pv > this.max)) {
                    this._to(this.max, 200, ease, this.change, function (value) {
                        console.log(1)
                        this.reboundEnd.call(this, value);
                        this.animationEnd.call(this, value);
                    }.bind(this));
                } else if ((this.hasMin && current < this.min)||(this.hasMin && current_custom_pv < this.min)) {
        ...
        _to: function (value, time, ease, onChange, onEnd) {
            ...
            var current_costom_pv=this.custom_pv
            var dv = value - current;
            var dv_custom_pv=value-current_costom_pv
            ...
            var toTick = function () {
                ...
                if (dt >= time) {
                    el[property] = value;
                    self.custom_pv=value;
                    onChange && onChange.call(self, value,self.custom_pv);
                    onEnd && onEnd.call(self, value,self.custom_pv);
                    return;
                }
                el[property] = dv * ease(dt / time) + current;
                self.custom_pv=dv_custom_pv* ease(dt / time) + current_costom_pv;
                self.tickID = requestAnimationFrame(toTick);
                //cancelAnimationFrame必须在 tickID = requestAnimationFrame(toTick);的后面
                onChange && onChange.call(self, el[property],self.custom_pv);
            };
            toTick();
        },
